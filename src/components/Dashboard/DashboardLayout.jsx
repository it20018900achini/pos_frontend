...
import { SidebarProvider } from "../../contextDashboard/SidebarProvider";
import { useSidebar } from "../../contextDashboard/hooks/useSidebar";
import { useSelector } from "react-redux";
import { use } from "react";
import StartShiftForm from "../../pages/cashier/StartShiftForm";
import POSHeader from "../../pages/cashier/components/POSHeader";
...
const DashboardLayout = () => {
  ...
  return (
    ...
    <SidebarProvider>
      ...
      {userProfile && userProfile.user && userProfile.lastShift?.status !== "OPEN"?<StartShiftForm branch={userProfile?.user?.branch}/>:<LayoutContent/>}
