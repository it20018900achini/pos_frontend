// src/redux/slices/customerOrderSlice.js
...
if (endDate) {
  ...
  params.append("end", formatted);
      ...
      const res = await api.get(
        `/api/orders/customer/t/${customerId}?${params.toString()}`,
{headers}
      );

      return res.data;
    } catch (err) {
      return thunkAPI.rejectWithValue(err.response?.data || "Failed to load orders");
    }
  }
);
